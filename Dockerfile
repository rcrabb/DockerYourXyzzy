...
# OVERRIDE:
# Specify geoip2 version until https://github.com/rcrabb/PretendYoureXyzzy/pull/228
RUN apk --no-cache add git openssh \
 && git clone -b $GIT_BRANCH https://github.com/rcrabb/PretendYoureXyzzy.git /project \
 && cd project \
